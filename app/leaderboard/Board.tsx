                ...
                <tr key={player.userID} className={`hover:bg-gray-700 ${getBackgroundColor(index)}`}>
                  ...
                  <td className="p-4 text-center">
                    <div className="text-lg font-semibold text-neutral-200">
                       {leaderboardType === 'overall' ? player.totalPoints.toFixed(0) : player.weeklyPoints.toFixed(0)} pts
                    </div>
                  </td>
                    <td className="p-4 text-center">
                      <div className="text-lg font-semibold text-neutral-200">
                        {leaderboardType === 'overall' ? player.averagePoints.toFixed(0) : player.averagePointsWeekly.toFixed(0)} pts
                      </div>
                    </td>
                    <td className="p-4 text-center">
                      <div className="text-lg font-semibold text-neutral-200">
                        {leaderboardType === 'overall' ? player.gamesPlayed.toFixed(0) : player.gamesPlayedWeekly.toFixed(0)}
                      </div>
                    </td>
                </tr>
              ))}
